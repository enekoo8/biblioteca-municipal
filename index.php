        ...
        <section class="libros">
            ...
            <table>
                ...
                <tr id="muestras">
                    ...
                    <td><a href="libros.php#Alicia"><img src="imagenes/alicia en el pais de las maravillas.jpg" alt="alicia" class="imagen"></a></td>
                    <td><a href="libros.php#cien_años_de_soledad"><img src="imagenes/cien años de soledad.jpg" alt="soledad" class="imagen"></a></td>
                    <td><a href="libros.php#el_señor_de_los_anillos"><img src="imagenes/el señor de los anillos.jpg" alt="anillos" class="imagen"></a></td>
                    <td><a href="libros.php#451"><img src="imagenes/fahrenheit 451.jpg" alt="451" class="imagen"></a></td>
                    <td><a href="libros.php#en_busca_de_un_tiempo_perdido"><img src="imagenes/En busca del tiempo perdido.jpg" alt="Tiempo perdido" class="imagen"></a></td>
                </tr>
                <tr id="ver_mas">
                    <td colspan="5"><a href="libros.php">Ver mas...</a></td>
                </tr>
            </table>
        </section>
        </section>
...
<footer>
    <section class="final">
        ...
        <br><br><a id="aviso_legal" href="index.php#aviso_legal">AVISO LEGAL</a>
